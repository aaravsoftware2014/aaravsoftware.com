		...
		<div class="swm-post-title-section">
			...
			<?php endif; ?>
				...
				if ( swm_get_option('swm_post_button_text','Read More') != '' ) { ?>
					<div class="swm-post-button"><a class="swm-button" href="<?php echo esc_url( get_permalink() ); ?>" ><?php echo wp_kses( swm_get_option('swm_post_button_text','Read More'),swm_kses_allowed_text() ); ?></a></div>
				<?php } ?>
